...
#include "EducationalMode.h"  // ✅ AJOUT
...
void drawSimulation(sf::RenderWindow& window, const sf::Font& font,
    ...
    // ===== Panneau d'info de la mission survolée (quand le panneau est fermé) =====
    ...
    // ✅ NOUVEAU : Dessiner le quiz éducatif
...
// ===== STRUCTURE INTERNE DES PLANÈTES - VERSION CORRIGÉE =====
void drawPlanetStructure(sf::RenderWindow& window, const sf::Font& font,
    ...
    // ✅ SUPPRIMÉ: La petite lune décorative qui cachait le texte
    // (Les lignes suivantes ont été retirées)
    // sf::CircleShape moonGlow(20.f);
    // sf::CircleShape moon(14.f);

    // ===== LÉGENDE DES COUCHES - POSITION AJUSTÉE =====
    float labelX = 530.f;
    float labelStartY = 220.f;  // ✅ CORRIGÉ: Remonté de 230 à 220
    float labelSpacing = 65.f;   // ✅ CORRIGÉ: Réduit de 70 à 65 pour mieux s'adapter
