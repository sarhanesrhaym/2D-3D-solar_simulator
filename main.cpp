...
int main() {
    ...
    // Boutons du menu principal - DISPOSITION EN TRIANGLE INVERSÉ EN BAS
    std::vector<CosmicButton> menuButtons;

    // ✅ COULEURS LUMINEUSES : BLEU NUIT + BLEU CIEL BRILLANT
    sf::Color btnNormalColor = sf::Color(20, 40, 70, 240);         // Bleu nuit
    sf::Color btnHoverColor = sf::Color(100, 180, 230, 255);       // Bleu ciel brillant
    sf::Color btnClickColor = sf::Color(173, 216, 230, 255);       // Light blue

    // ✅ POSITIONS EN TRIANGLE INVERSÉ EN BAS DE L'ÉCRAN
    float btnWidth = 280.f;
    float btnHeight = 50.f;
    float screenCenterX = 600.f;
    float bottomY = 720.f;
    float topY = 640.f;
    float horizontalSpacing = 320.f;
    ...
    // Bouton 2 - PRESENTATION (en bas à gauche)
    menuButtons.push_back(CosmicButton(
        sf::Vector2f(screenCenterX - horizontalSpacing / 2.f - btnWidth, bottomY),
        sf::Vector2f(btnWidth, btnHeight),
        "PRESENTATION",
        btnNormalColor,
        btnHoverColor,
    ...
    // Bouton 3 - EQUIPE (en bas à droite)
    menuButtons.push_back(CosmicButton(
        sf::Vector2f(screenCenterX + horizontalSpacing / 2.f, bottomY),
        sf::Vector2f(btnWidth, btnHeight),
        "EQUIPE",
        btnNormalColor,
        btnHoverColor,
    ...
    backButtons.push_back(CosmicButton(
        ...
        "RETOUR",
        sf::Color(183, 28, 28, 200),       // normalCol (rouge)
        sf::Color(198, 40, 40, 200),       // hoverCol
